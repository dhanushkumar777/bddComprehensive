...
import com.pageobject.CommitmentPage;
import com.pageobject.CouponPage;
...
public class CouponStepDefinition extends BrowserHelper{
	
	CouponPage mp = new CouponPage(driver);
